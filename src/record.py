...
class Recorder:
    ...
    def record(self):
        ...
        testDict = data = {"laptimes": [[69.165, 69.712, 70.309, 70.148, 69.352, 70.695, 70.408, 70.485, 70.107, 69.881, 70.344, 69.786, 70.267, 70.335, 70.373, 70.071, 70.698, 70.109, 71.897, 72],
        ...
        with open('AustriaTestData.yaml', 'w') as handle:
            yaml.dump(testDict, handle, default_flow_style=False)
